...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"; // Assuming Tabs component is available
import { AccessibilitySettings } from '@/components/AccessibilitySettings'; // Assuming AccessibilitySettings component is created
        ...
        >
          ...
          <Tabs defaultValue="general" className="w-full">
            <TabsList className="grid w-full grid-cols-5">
              ...
              <TabsTrigger value="help">Help & Tutorials</TabsTrigger>
